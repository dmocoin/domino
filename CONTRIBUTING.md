Contributing to Domino Core
============================

The Domino Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Domino Core project, and is not to be
confused with overall Domino Network Protocol consensus changes.

Whether a pull request is merged into Domino Core rests with the project merge
...
Patches that change Domino consensus rules are considerably more involved than
...
Where a patch set proposes to change the Domino consensus, it must have been
...
The project leader is the release manager for each Domino Core release.
