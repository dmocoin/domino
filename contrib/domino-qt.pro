...
RESOURCES += src/qt/domino.qrc src/qt/domino_locale.qrc

TRANSLATIONS += src/qt/locale/domino_bg.ts \
                src/qt/locale/domino_de.ts \
                src/qt/locale/domino_en.ts \
                src/qt/locale/domino_es.ts \
                src/qt/locale/domino_fi.ts \
                src/qt/locale/domino_fr.ts \
                src/qt/locale/domino_it.ts \
                src/qt/locale/domino_ja.ts \
                src/qt/locale/domino_pl.ts \
                src/qt/locale/domino_pt.ts \
                src/qt/locale/domino_ru.ts \
                src/qt/locale/domino_sk.ts \
                src/qt/locale/domino_sv.ts \
                src/qt/locale/domino_vi.ts \
                src/qt/locale/domino_zh_CN.ts \
                src/qt/locale/domino_zh_TW.ts
