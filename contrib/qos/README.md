...
This means one can have an always-on dominod instance running, and another local dominod/domino-qt instance which connects to this node and receives blocks from it.
