Domino Core version 2.2.1 is now available from:

  <https://github.com/domino-project/domino/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/domino-project/domino/issues>

Compatibility
==============

Domino Core is extensively tested on multiple operating systems using
...
Domino Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Domino was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/domino-project-translations/).
