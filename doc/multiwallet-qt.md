...
In order to support loading of multiple wallets in domino-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is domino.cpp.
...
Changes to domino.cpp
----------------------
domino.cpp is the entry point into domino-qt, and as such, will require some minor modifications to provide hooks for
