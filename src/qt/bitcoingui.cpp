                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Domino Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Domino address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and domino: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Domino Core"), this);
    aboutAction->setStatusTip(tr("Show information about Domino Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Domino"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Domino addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Domino addresses"));
    ...
    openAction->setStatusTip(tr("Open a Domino: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Domino Core help message to get a list with possible Domino command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Domino Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Domino network", "", count));
}
...
{
    QString strTitle = tr("Domino Core"); // default title
