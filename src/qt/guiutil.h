...
/** Utility functions used by the Domino Qt UI.
 */
namespace GUIUtil
{
...
// Render Domino addresses in monospace font
...
// Parse "domino:" URI into recipient object, return true on successful parsing
